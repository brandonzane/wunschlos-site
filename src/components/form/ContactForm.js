...
class ContactForm extends Component {
    constructor( props ) {
        ...
        this.state = {
            ...
            warningMessage: 'Please fill in the form!',
        ...
        return (
            <form method="post" onSubmit={ this.submitForm } id="cf-1" className="contact-form">
                <div className="form-group form-group-lg">
                    <p className="input-group gutter-width-sm no-space">
                        <span className="gutter-width">
                            <label className="form-label-lg before after mb-0" htmlFor="cf-1-name-surename">Name and Surname *</label>
                        ...
                        <span className="gutter-width">
                            ...
                            <select name="services"
                                    ...
                                    onChange={ this.handleInputChange }>
                                <option value="hair-treatments">Marketing</option>
                                <option value="face-and-body">Web Development</option>
                                <option value="hands-feets">Design</option>
                                <option
                                    value="haircuts-for-men">App Development</option>
                            </select>
                        </span>
                    </p>
                </div>
                ...
                <div className="form-group form-group-lg mb-0">
                    <button type="submit" className="btn btn-outline-secondary text-uppercase">Send Message</button>
                </div>
            </form>
        );
    }
